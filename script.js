...
const translations = {
    en: {
        ...
        'martin-title': 'Character Artist',
        'ognen-title': 'Public Relations Coordinator',
        'filip-title': 'Environment Arist',
    ...
    mk: {
        ...
        'team-title': "Запознај се со Тимот",
        'fitz-title': 'Креатор',
        'aco-title': 'Креатор',
        'hristina-title': 'Координатор на проект',
        'martin-title': 'Уметник на карактери',
        'ognen-title': 'Координатор за односи со јавност',
        'filip-title': 'Уметник на позадини',
